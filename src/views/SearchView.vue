...
<template>
  ...
  const results = ref([
    ...
    { category: ["Giro", "Movimientos Manos", "Desplazamiento Circulo"], arts: "PASOS", image: "../../public/images/buscador/8.png",  genero: "Bachata", cancion: "Obsesión", artista: "Aventura" },
    ...
    { category: ["Desplazamiento Lateral", "Paso Basico", "Movimientos Sensuales"], arts: "PASOS", image: "../../public/images/buscador/10.png", genero: "Bachata", cancion: "Me Enamoré de Ti", artista: "Chayanne" },
